...
'Creamos un nuevo TestObject para el link de Delete Account login\r\n'
Delete = new TestObject('Delete')

'Decimos que este testobject contiene la propiedad Xpath que nos interesa'
Delete.addProperty('xpath', ConditionType.EQUALS, "//a[@class='userPanelLink userPanelDeleteAccountLink'][@href='/user/deleteAccount']", true)
...
'Decimos que este testobject contiene la propiedad Xpath que nos interesa'
Pass.addProperty('xpath', ConditionType.EQUALS, "//input[@type='password'][@class='form-control formField deleteAccountField required']", true)

'rellenamos  el test con la pass habitual: pass1 Obect\r\n'
WebUI.setText(Pass,'pass1')


'Creamos un nuevo TestObject para el Boton de confirmacion de eliminacion \r\n'
BtnDelete = new TestObject('BtnDelete')

'Decimos que este testobject contiene la propiedad Xpath que nos interesa'
BtnDelete.addProperty('xpath', ConditionType.EQUALS, "//input[@id='deleteAccountSubmit']", true)

'Clickamos  el test Obect\r\n'
...
'clickamos para continuar a la pantalla de destrucción de usuario'
WebUI.click(findTestObject('ObjetosLogin/ObjetosDelete/Page_Herman Miller/a_Delete account'))

'Tecleamos nuestra contraseña en el control input_password'
WebUI.setText(findTestObject('ObjetosLogin/ObjetosDelete/Page_Herman Miller (1)/input_password'), 'pass1')

'Clickamos para finalmente destruir la cuenta'
WebUI.click(findTestObject('ObjetosLogin/ObjetosDelete/Page_Herman Miller (1)/input_deleteAccountSubmit'))
